...
public class TextureChooser
{
    ...
    private static readonly Texture2D LeftArrow;
    private static readonly Texture2D RightArrow;
    ...
    static TextureChooser()
    {
        ...
        {
            throw new Exception(
                $"Include left/right arrows at 'UI/Icons/[Left|Right]Arrow' when using TextureChooser.{ex}");
        }
    }
